...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Demon Fox  chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Demon Fox ", HidePremium = false, IntroText = "Demon Fox ⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Demon Fox  SCRIPT")
W:AddLabel("DiscordDemon Fox ")
local Section = W:AddSection({
    Name = "Status"
})
